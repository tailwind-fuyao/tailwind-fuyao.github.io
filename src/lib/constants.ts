...
export const TIER_SPONSORS: TierSponsor[] = [
  ...
  },
  {
    ...
    description:
      "未名天使（Weiming Angels）成立于 2014 年 1 月，是主要由在硅谷的北大校友发起并组织的天使投资俱乐部，也是硅谷活跃的华人天使投资人网络，现有 40 余位天使投资人。未名天使每月评估创业项目，主要关注估值 1000 万美元以下的早期公司，由成员共同完成尽职调查与投资决策，并在资金之外为创业者提供行业指导与管理辅导。",
  },
  {
